...
import spaceship from '../../assets/spaceship/png/spaceship.png'; // Importing spaceship image
  ...
  return (
    <HeroContainer>
      <LeftContainer>
        ...
        <GradientText>I'm Pranjal Kundu.</GradientText> {/* Display name with gradient effect */}
