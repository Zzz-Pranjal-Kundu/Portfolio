...
import ScheduloViz from '../../assets/projects/ScheduloViz.gif';
import SyncIDEGIF from '../../assets/projects/SyncIDEGIF.gif';
import MoshiMoshi from '../../assets/projects/MoshiMoshi.jpg';
  ...
  return (
    <ProjectsContainer id="projects">
      ...
      <BigProjectsContainer>
        <ProjectContainer>
          <img src={ScheduloViz} alt="ScheduloViz" />
          <h3>ScheduloViz</h3>
          <p>ScheduloViz is a visual simulator for process and disk scheduling algorithms, 
          helping students understand system behavior through clear comparisons and dynamic visualizations.</p>
          <div className="links">
            <a href="https://github.com/Zzz-Pranjal-Kundu/OperatingSystemAlgoSimulator" target="_blank" rel="noopener noreferrer">
              <FaGithub /> See on GitHub
            </a>
            <a href="https://os-algo-simulator.vercel.app/" target="_blank" rel="noopener noreferrer">
              <FaGlobe /> Try it Out
            </a>
          </div>
        </ProjectContainer>
        <ProjectContainer>
          <img src={SyncIDEGIF} alt="SyncIDE" />
          <h3>SyncIDE</h3>
          <p>SyncIDE is a real-time collaborative coding platform with multi-language support, compiler phase visualization, 
            live debugging, and code sharing—tailored for learning and understanding compilers interactively.</p>
          <div className="links">
            <a href="https://github.com/Zzz-Pranjal-Kundu/SyncIDE" target="_blank" rel="noopener noreferrer">
              <FaGithub /> See on GitHub
            </a>
          </div>
        </ProjectContainer>
      ...
      <SmallProjectsContainer>
        <SmallProject>
          <img src={MoshiMoshi} alt="MoshiMoshi" />
          <h3>MoshiMoshi</h3>
          <p>MoshiMoshi a secure, real time chatting application.</p>
          <div className="links">
            <a href="https://github.com/Zzz-Pranjal-Kundu/MoshiMoshi" target="_blank" rel="noopener noreferrer">
              <FaGithub /> See on GitHub
            </a>
        ...
        <SmallProject>
          ...
          <p>Stay tuned!</p>
          <div className="links">
            <a href="https://github.com/Zzz-Pranjal-Kundu" target="_blank" rel="noopener noreferrer">
              <FaGithub /> See on GitHub
            </a>
            <a href="https://github.com/Zzz-Pranjal-Kundu" target="_blank" rel="noopener noreferrer">
              <FaGlobe /> Try it Out
